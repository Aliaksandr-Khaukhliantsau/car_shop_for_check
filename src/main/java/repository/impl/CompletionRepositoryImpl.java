...
public class CompletionRepositoryImpl implements CompletionRepository {
    ...
    public ResultSet getCompletionByCompletionId(UUID completionId) throws SQLException {
        ...
        String SQL_GET_COMPLETION_BY_COMPLETION_ID = "SELECT * FROM completions WHERE id = " + "'" + completionId + "'" + " ORDER BY name ASC;";
        ResultSet resultSet = statement.executeQuery(SQL_GET_COMPLETION_BY_COMPLETION_ID);
//        statement.close();
        return resultSet;
    }
    ...
    public ResultSet getCompletionByCompletionName(String completionName) throws SQLException {
        Statement statement = connection.createStatement();
        String SQL_GET_COMPLETION_BY_COMPLETION_NAME = "SELECT * FROM completions WHERE name = " + "'" + completionName + "'" + " ORDER BY name ASC;";
        ResultSet resultSet = statement.executeQuery(SQL_GET_COMPLETION_BY_COMPLETION_NAME);
//        statement.close();
        return resultSet;
    }
    ...
    public ResultSet getAllCompletions() throws SQLException {
        Statement statement = connection.createStatement();
        ResultSet resultSet = statement.executeQuery(SQL_GET_ALL_COMPLETIONS);
//        statement.close();
        return resultSet;
    }
    ...
    public void addCarOption(UUID completionId, UUID optionId) throws SQLException {
        Statement statement = connection.createStatement();
        String SQL_ADD_A_CAR_OPTION = "INSERT INTO completionsoptions (idcompletion, idoption) VALUES ('" + completionId + "', '" + optionId + "') RETURNING *;";
        statement.executeQuery(SQL_ADD_A_CAR_OPTION);
        statement.close();
    }
    ...
    public void deleteCarOption(UUID completionId, UUID optionId) throws SQLException {
        Statement statement = connection.createStatement();
        String SQL_DELETE_A_CAR_OPTION = "DELETE FROM completionsoptions WHERE idcompletion = '" + completionId + "' AND idoption = '" + optionId + "' RETURNING *;";
    ...
    public void create(String completionName) throws SQLException {
        Statement statement = connection.createStatement();
        String SQL_CREATE_A_COMPLETION = "INSERT INTO completions (name) VALUES ('" + completionName + "') RETURNING *;";
        statement.executeQuery(SQL_CREATE_A_COMPLETION);
        statement.close();
    }
    ...
    public void update(UUID completionId, String completionName) throws SQLException {
        Statement statement = connection.createStatement();
        String SQL_UPDATE_A_COMPLETION = "UPDATE completions SET name = '" + completionName + "' WHERE id = '" + completionId + "' RETURNING *;";
        statement.executeQuery(SQL_UPDATE_A_COMPLETION);
        statement.close();
    }
