package car.shop.old.repository;

import car.shop.old.entity.Setting;
...
public interface SettingRepository {
    ...
    /**
     * Retrieves a car setting by its ID.
     *
     * @param id the ID of the car setting.
     * @return the car setting entity.
     * @throws SQLException if a database access error occurs.
     */
    Setting getById(UUID id) throws SQLException;

    /**
     * Retrieves a car setting by its name.
     *
     * @param settingName the name of the car setting.
     * @return the car setting entity.
     * @throws SQLException if a database access error occurs.
     */
    Setting getBySettingName(String settingName) throws SQLException;

    /**
     * Retrieves all car settings for a specific completion.
     *
     * @param completionId the ID of the completion.
     * @return a list of car setting entities.
     * @throws SQLException if a database access error occurs.
     */
    List<Setting> getByCompletionId(UUID completionId) throws SQLException;

    /**
     * Retrieves all car settings.
     *
     * @return a list of all car setting entities.
     * @throws SQLException if a database access error occurs.
     */
